 ...
 *
 * The fixtures in tests/fixtures/grovedb/ are produced by the Rust test
 * `crates/storage/tests/generate_ts_fixtures.rs` (run with
 * `cargo test --release -p willow-storage --test generate_ts_fixtures --
 * --ignored`). Each fixture contains real proof bytes and root hashes
 * generated by the canonical Rust GroveDB implementation.
 *
