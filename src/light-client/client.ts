...
export class LightClient {
   ...
   *
   * Fetches the latest block from validators and trusts it as the initial
   * state. Every subsequent block is verified against that initial trusted
   * state. Pin a known-good checkpoint header instead for production
   * deployments.
   */
